...
\begin{frame}{Annexe : Principe de Lefschetz}
...
\begin{frame}{Annexe : Principe de Lefschetz}
\begin{exampleblock}{Esquisse de la preuve}
$\Sigma$ ne peut empêcher qu'un nombre fini de caractéristiques positives. Il existe $p \in \mathbb{P}$ suffisament grand
