...
notre système de preuve est correct: si $T \vdash \phi$, alors $T \models \phi$. Nous omettons la vérification de ce résultat pour nous concentrer sur l'implication réciproque.
\end{rema}
...
$\sigma$ étant par définition finie, elle fait appel à un nombre fini d'axiomes de $T$. Ainsi on a l'existence de $T_0 \subset T$ un sous-ensemble 
